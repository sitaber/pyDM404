The pyDM404 is a cross platform drum machine written in Python. The source code will run on any machine the can install its dependencies. Executable binaries are available for Windows and Ubuntu.
